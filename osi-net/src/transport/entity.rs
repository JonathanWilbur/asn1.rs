...
//             }
//             let remote_ref = (n.id(), cr.src_ref); // FIXME: Instead of n.id(), just use IP address.
...
//                 if conn.assigned_network_conn.is_some_and(|nc| nc == n.id()) { // FIXME: Make this ((IpAddr, Option<u16>, NSType), TransportRef)
