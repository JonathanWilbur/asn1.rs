//! ASN.1 data structures from the Lightweight-Directory-Access-Protocol-V3 module
...
pub fn _decode_LDAPMessage(el: &X690Element) -> ASN1Result<LDAPMessage> {
    ...
    Ok(LDAPMessage {
        messageID: messageID.unwrap(),
        protocolOp: protocolOp.unwrap(),
        controls,
        _unrecognized,
    })
}
        ...
        match _component_name {
            ...
            "controls" => |el: &X690Element| -> ASN1Result<()> {
                if el.tag.tag_class != TagClass::CONTEXT || el.tag.tag_number != 0 {
                    return Err(
                        el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "controls")
                    );
                }
...
pub fn _decode_AttributeValueAssertion(el: &X690Element) -> ASN1Result<AttributeValueAssertion> {
    ...
    Ok(AttributeValueAssertion {
        attributeDesc: attributeDesc.unwrap(),
        assertionValue: assertionValue.unwrap(),
        _unrecognized,
    })
}
...
pub fn _decode_PartialAttribute(el: &X690Element) -> ASN1Result<PartialAttribute> {
    let _elements = match &el.value {
        ...
        _ => {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "PartialAttribute")
            )
        }
    };
    let _seq_iter = X690StructureIterator::new(
    ...
    for _fallible_component_name in _seq_iter {
        ...
        match _component_name {
            ...
            "vals" => {
                vals = Some(|el: &X690Element| -> ASN1Result<SET_OF<AttributeValue>> {
                    let elements = match &el.value {
                        X690Value::Constructed(children) => children,
                        _ => {
                            return Err(
                                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "vals")
                            )
                        }
                    };
...
pub fn _validate_PartialAttribute(el: &X690Element) -> ASN1Result<()> {
    ...
    for _fallible_component_name in _seq_iter {
        ...
        match _component_name {
            ...
            "vals" => |el: &X690Element| -> ASN1Result<()> {
                match &el.value {
...
pub fn _decode_LDAPResult(el: &X690Element) -> ASN1Result<LDAPResult> {
    ...
    Ok(LDAPResult {
        resultCode: resultCode.unwrap(),
        matchedDN: matchedDN.unwrap(),
        diagnosticMessage: diagnosticMessage.unwrap(),
        referral,
        _unrecognized,
    })
}
        ...
        match _component_name {
            ...
            "referral" => |el: &X690Element| -> ASN1Result<()> {
                if el.tag.tag_class != TagClass::CONTEXT || el.tag.tag_number != 3 {
                    return Err(
                        el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "referral")
                    );
                }
    ...
    |el: &X690Element| -> ASN1Result<()> {
        ...
        Ok(|el: &X690Element| -> ASN1Result<()> {
            let _elements = match &el.value {
                ...
                _ => {
                    return Err(
                        el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "BindRequest")
                    )
                }
            };
            let _seq_iter = X690StructureIterator::new(
...
pub fn _decode_BindResponse(el: &X690Element) -> ASN1Result<BindResponse> {
    |el: &X690Element| -> ASN1Result<BindResponse> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "BindResponse")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
...
pub fn _decode_SearchRequest(el: &X690Element) -> ASN1Result<SearchRequest> {
    |el: &X690Element| -> ASN1Result<SearchRequest> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "SearchRequest")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
        ...
        Ok(SearchRequest {
            baseObject: baseObject.unwrap(),
            scope: scope.unwrap(),
            derefAliases: derefAliases.unwrap(),
            sizeLimit: sizeLimit.unwrap(),
            timeLimit: timeLimit.unwrap(),
            typesOnly: typesOnly.unwrap(),
...
pub fn _decode_Filter(el: &X690Element) -> ASN1Result<Filter> {
    match (el.tag.tag_class, el.tag.tag_number) {
        (TagClass::CONTEXT, 0) => Ok(Filter::and(
            |el: &X690Element| -> ASN1Result<SET_OF<Filter>> {
                let elements = match &el.value {
                    X690Value::Constructed(children) => children,
                    _ => {
        ...
        (TagClass::CONTEXT, 2) => Ok(Filter::not(Box::new(
...
pub fn _encode_Filter(value_: &Filter) -> ASN1Result<X690Element> {
    match value_ {
        Filter::and(v) => |v_1: &Vec<Filter>| -> ASN1Result<X690Element> {
            let mut el_1 = |value_: &SET_OF<Filter>| -> ASN1Result<X690Element> {
                let mut children: Vec<X690Element> = Vec::with_capacity(value_.len());
                for v in value_ {
        ...
        Filter::equalityMatch(v) => |v_1: &AttributeValueAssertion| -> ASN1Result<X690Element> {
        ...
        Filter::greaterOrEqual(v) => |v_1: &AttributeValueAssertion| -> ASN1Result<X690Element> {
            let mut el_1 = _encode_AttributeValueAssertion(&v_1)?;
            el_1.tag.tag_class = TagClass::CONTEXT;
        ...
        Filter::extensibleMatch(v) => |v_1: &MatchingRuleAssertion| -> ASN1Result<X690Element> {
    ...
    match (el.tag.tag_class, el.tag.tag_number) {
        ...
        (TagClass::CONTEXT, 8) => |el: &X690Element| -> ASN1Result<()> {
            if el.tag.tag_class != TagClass::CONTEXT || el.tag.tag_number != 8 {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "approxMatch")
                );
            }
            Ok(_validate_AttributeValueAssertion(&el)?)
        }(&el),
...
pub fn _decode_SubstringFilter(el: &X690Element) -> ASN1Result<SubstringFilter> {
    let _elements = match &el.value {
        X690Value::Constructed(children) => children,
        _ => {
            return Err(el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "SubstringFilter"))
        }
    };
    let _seq_iter = X690StructureIterator::new(
        _elements.as_slice(),
    ...
    for _fallible_component_name in _seq_iter {
        ...
        match _component_name {
            "type" => type_ = Some(_decode_AttributeDescription(_el)?),
            "substrings" => {
                substrings = Some(|el: &X690Element| -> ASN1Result<
                    SEQUENCE_OF<SubstringFilter_substrings_substring>,
                > {
                    let elements = match &el.value {
                        X690Value::Constructed(children) => children,
                        _ => {
...
pub fn _validate_SubstringFilter(el: &X690Element) -> ASN1Result<()> {
    ...
    for _fallible_component_name in _seq_iter {
        ...
        match _component_name {
            "type" => _validate_AttributeDescription(_el)?,
            "substrings" => |el: &X690Element| -> ASN1Result<()> {
                match &el.value {
                    X690Value::Constructed(subs) => {
                        for sub in subs.iter() {
                    ...
                    _ => {
                        Err(el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "substrings"))
                    }
                }
            }(_el)?,
            _ => (),
...
pub fn _decode_SearchResultEntry(el: &X690Element) -> ASN1Result<SearchResultEntry> {
    |el: &X690Element| -> ASN1Result<SearchResultEntry> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "SearchResultEntry")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
...
pub fn _decode_PartialAttributeList(el: &X690Element) -> ASN1Result<PartialAttributeList> {
    let elements = match &el.value {
        ...
        _ => {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "PartialAttributeList")
            )
        }
    };
...
pub fn _validate_SearchResultReference(el: &X690Element) -> ASN1Result<()> {
    |el: &X690Element| -> ASN1Result<()> {
        if el.tag.tag_class != TagClass::APPLICATION || el.tag.tag_number != 19 {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "SearchResultReference")
            );
        }
        Ok(|el: &X690Element| -> ASN1Result<()> {
            match &el.value {
...
pub fn _validate_SearchResultDone(el: &X690Element) -> ASN1Result<()> {
    |el: &X690Element| -> ASN1Result<()> {
        if el.tag.tag_class != TagClass::APPLICATION || el.tag.tag_number != 5 {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "SearchResultDone")
            );
        }
...
pub fn _decode_ModifyRequest(el: &X690Element) -> ASN1Result<ModifyRequest> {
    |el: &X690Element| -> ASN1Result<ModifyRequest> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ModifyRequest")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
        ...
        for _fallible_component_name in _seq_iter {
            ...
            match _component_name {
                ...
                "changes" => {
                    changes = Some(|el: &X690Element| -> ASN1Result<
                        SEQUENCE_OF<ModifyRequest_changes_change>,
                    > {
                        let elements = match &el.value {
                            X690Value::Constructed(children) => children,
                            _ => {
        ...
        Ok(|el: &X690Element| -> ASN1Result<()> {
            ...
            for _fallible_component_name in _seq_iter {
                ...
                match _component_name {
                    ...
                    "changes" => |el: &X690Element| -> ASN1Result<()> {
                        match &el.value {
                            X690Value::Constructed(subs) => {
                                for sub in subs.iter() {
                            ...
                            _ => Err(el
                                .to_asn1_err_named(ASN1ErrorCode::invalid_construction, "changes")),
                        }
                    }(_el)?,
                    _ => (),
                }
...
impl AddRequest {
    pub fn new(entry: LDAPDN, attributes: AttributeList, _unrecognized: Vec<X690Element>) -> Self {
        AddRequest {
            entry,
            attributes,
            _unrecognized,
    ...
    |el: &X690Element| -> ASN1Result<()> {
        ...
        Ok(|el: &X690Element| -> ASN1Result<()> {
            let _elements = match &el.value {
                ...
                _ => {
                    return Err(
                        el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "AddRequest")
                    )
                }
            };
            let _seq_iter = X690StructureIterator::new(
...
pub fn _decode_ModifyDNRequest(el: &X690Element) -> ASN1Result<ModifyDNRequest> {
    |el: &X690Element| -> ASN1Result<ModifyDNRequest> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ModifyDNRequest")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
        ...
        Ok(ModifyDNRequest {
            entry: entry.unwrap(),
            newrdn: newrdn.unwrap(),
            deleteoldrdn: deleteoldrdn.unwrap(),
            newSuperior,
            _unrecognized,
        })
    }(&el)
    ...
    |el: &X690Element| -> ASN1Result<()> {
        ...
        Ok(|el: &X690Element| -> ASN1Result<()> {
            let _elements = match &el.value {
                ...
                _ => {
                    return Err(el
                        .to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ModifyDNRequest"))
                }
            };
            let _seq_iter = X690StructureIterator::new(
                _elements.as_slice(),
...
pub fn _validate_ModifyDNResponse(el: &X690Element) -> ASN1Result<()> {
    |el: &X690Element| -> ASN1Result<()> {
        if el.tag.tag_class != TagClass::APPLICATION || el.tag.tag_number != 13 {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ModifyDNResponse")
            );
        }
        Ok(_validate_LDAPResult(&el)?)
    }(&el)
...
pub fn _decode_CompareRequest(el: &X690Element) -> ASN1Result<CompareRequest> {
    |el: &X690Element| -> ASN1Result<CompareRequest> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "CompareRequest")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
...
pub fn _validate_CompareResponse(el: &X690Element) -> ASN1Result<()> {
    |el: &X690Element| -> ASN1Result<()> {
        if el.tag.tag_class != TagClass::APPLICATION || el.tag.tag_number != 15 {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "CompareResponse")
            );
        }
        Ok(_validate_LDAPResult(&el)?)
    }(&el)
...
pub fn _decode_ExtendedRequest(el: &X690Element) -> ASN1Result<ExtendedRequest> {
    |el: &X690Element| -> ASN1Result<ExtendedRequest> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ExtendedRequest")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
        ...
        Ok(ExtendedRequest {
            requestName: requestName.unwrap(),
            requestValue,
            _unrecognized,
        })
    }(&el)
    ...
    |el: &X690Element| -> ASN1Result<()> {
        ...
        Ok(|el: &X690Element| -> ASN1Result<()> {
            let _elements = match &el.value {
                ...
                _ => {
                    return Err(el
                        .to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ExtendedRequest"))
                }
            };
            let _seq_iter = X690StructureIterator::new(
                _elements.as_slice(),
...
pub fn _decode_ExtendedResponse(el: &X690Element) -> ASN1Result<ExtendedResponse> {
    |el: &X690Element| -> ASN1Result<ExtendedResponse> {
        let _elements = match &el.value {
            ...
            _ => {
                return Err(
                    el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "ExtendedResponse")
                )
            }
        };
        let _seq_iter = X690StructureIterator::new(
...
pub fn _validate_IntermediateResponse(el: &X690Element) -> ASN1Result<()> {
    |el: &X690Element| -> ASN1Result<()> {
        if el.tag.tag_class != TagClass::APPLICATION || el.tag.tag_number != 25 {
            return Err(
                el.to_asn1_err_named(ASN1ErrorCode::invalid_construction, "IntermediateResponse")
            );
        }
        Ok(|el: &X690Element| -> ASN1Result<()> {
            let _elements = match &el.value {
...
pub fn _decode_LDAPMessage_protocolOp(el: &X690Element) -> ASN1Result<LDAPMessage_protocolOp> {
    match (el.tag.tag_class, el.tag.tag_number) {
        (TagClass::APPLICATION, 0) => Ok(LDAPMessage_protocolOp::bindRequest(_decode_BindRequest(
            &el,
        )?)),
        ...
        (TagClass::APPLICATION, 9) => Ok(LDAPMessage_protocolOp::addResponse(_decode_AddResponse(
            &el,
        )?)),
